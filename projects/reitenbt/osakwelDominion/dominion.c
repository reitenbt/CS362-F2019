...
int tributeCardEffect(struct gameState* state, int handPos, int nextPlayer, int currentPlayer, int* tributeRevealedCards);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        mineCardEffect(state, currentPlayer, choice1, choice2, handPos);
    ...
    case baron:
        baronCardEffect (state, choice1, currentPlayer, handPos);
    ...
    case minion:
        minionCardEffect(state, handPos, currentPlayer, choice1, choice2);
    ...
    case tribute:
        tributeCardEffect(state, handPos, nextPlayer, currentPlayer, tributeRevealedCards);
...
int baronCardEffect (struct gameState *state, int choice1, int currentPlayer, int handPos) 
{
